  ...
  return (
    ...
    <div className="min-h-dvh flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-4">
      <form
        ...
        className="w-full max-w-sm bg-white dark:bg-gray-900 rounded-2xl shadow-md p-8"
      >
        <div className="flex justify-center mb-6">
          <LogoWithWordmark size={32} />
        </div>
        <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-6 text-center">Admin Login</h1>
        ...
        <input
          ...
          className="w-full mb-4 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-violet-400"
        />
        ...
        <input
          ...
          className="w-full mb-6 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-violet-400"
        />
