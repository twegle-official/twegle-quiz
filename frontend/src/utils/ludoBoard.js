...
// beside red's yard and self-corrects direction so index 13 lands near
// green's yard — both checked, along with the resulting indices for green
// (13)/yellow (26)/blue (39) landing exactly where PATH_OFFSET expects,
// via a runtime assertion below (this board has no automated test suite,
// so the check needs to live where it can't be silently skipped).
