...
You don't have to go to My Account every time, either — the "Share Twegle" icons already on every page (the floating icons on desktop, the footer's share section on any screen size) automatically switch to sharing *your* invite link the moment you're logged in, with the label changing to "Invite friends" so it's clear what's happening. Logged-out visitors keep seeing the plain "Share Twegle" behavior, exactly as before.
